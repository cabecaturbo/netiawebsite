...
import { gyrochrome, sora, inter } from "./fonts";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${sora.variable} ${gyrochrome.variable}`}>
      <head>
        <script 
          id="vtag-ai-js" 
          async 
      ...
      <body className="font-sans antialiased bg-white text-fg">
        ...
        {/* Netia Chat Widget */}
        <div id="netia-chat-widget" style={{ position: 'fixed', bottom: '20px', right: '20px', zIndex: 9999 }}>
