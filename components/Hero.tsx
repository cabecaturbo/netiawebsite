        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-1 flex items-center gap-0">
              ...
              <div className="relative h-7 w-[104px] md:h-8 md:w-[116px] ml-1">
                <Image src="/openai-logo.png" alt="OpenAI" fill sizes="(max-width: 768px) 104px, 116px" className="object-contain" />
              </div>
            </div>
          ...
          <div className="hidden md:block">
            <div className="relative overflow-hidden rounded-xl border bg-white p-6 shadow-sm h-[30rem]">
              ...
              <div className="pt-4 space-y-4 h-[25rem] overflow-hidden">
                {/* Customer */}
